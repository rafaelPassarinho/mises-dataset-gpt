...
block_size = 256 # what is the maximum context lengh for prediction?
max_iters = 5000
eval_interval = 500
learning_rate = 3e-4
...
class BigramModel(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        # idx and tatgets are both (B,T) tensors of integers
    ...
    def generate(self, idx, max_new_tokens):
        ...
        for _ in range(max_new_tokens):
            ...
            idx_new = torch.multinomial(probs, num_samples=1) # (B, 1)
